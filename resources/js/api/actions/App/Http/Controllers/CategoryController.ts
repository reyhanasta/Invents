...
/**
* @see \App\Http\Controllers\CategoryController::deleteMethod
 * @see app/Http/Controllers/CategoryController.php:79
 * @route '/categories/{category}'
 */
export const deleteMethod = (args: { category: number | { id: number } } | [category: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
 ...
 * @route '/categories/{category}'
 */
deleteMethod.url = (args: { category: number | { id: number } } | [category: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { category: args }
    }
 ...
 * @route '/categories/{category}'
 */
deleteMethod.delete = (args: { category: number | { id: number } } | [category: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
    url: deleteMethod.url(args, options),
    method: 'delete',
})
 ...
 * @route '/categories/{category}'
 */
    const deleteMethodForm = (args: { category: number | { id: number } } | [category: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/categories/{category}'
 */
        deleteMethodForm.delete = (args: { category: number | { id: number } } | [category: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: deleteMethod.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'DELETE',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
...
const CategoryController = { index, store, update, deleteMethod, delete: deleteMethod }
