...
import { dashboard, maintenances } from '@/routes';
                ...
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <Card>
                        ...
                        <CardContent>
                            ...
                            <p className="text-xs text-muted-foreground">
                                {(
                                    (stats.in_use / (stats.total_assets || 1)) *
                                    100
                                ).toFixed(1)}
                                % dari total aset
                            </p>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold">
                                {stats.recent_maintenances.length}
                            </div>
                            <p className="text-xs text-muted-foreground">
                                Proses pemeliharaan berjalan
                            </p>
                        </CardContent>
                    </Card>
                    <Card>
                            ...
                            <div className="space-y-4">
                                <div className="grid grid-cols-3 gap-4 text-center">
                                    ...
                                    <div className="space-y-1">
                                        <div className="text-2xl font-bold text-yellow-600">
                                            {stats.condition_stats.minor_damage}
                                        </div>
                                        <div className="text-xs text-muted-foreground uppercase">
                                            Rusak Ringan
                                        </div>
                                    ...
                                    <div className="space-y-1">
                                        <div className="text-2xl font-bold text-red-600">
                                            {stats.condition_stats.major_damage}
                                        </div>
                                        <div className="text-xs text-muted-foreground uppercase">
                                            Rusak Berat
                                        </div>
                                ...
                                <div className="flex h-4 w-full overflow-hidden rounded-full bg-secondary">
                                    <div
                                        ...
                                        style={{
                                            width: `${(stats.condition_stats.good / stats.total_assets) * 100}%`,
                                        }}
                                    />
                                    <div
                                        className="h-full bg-yellow-500"
                                        style={{
                                            width: `${(stats.condition_stats.minor_damage / stats.total_assets) * 100}%`,
                                        }}
                                    />
                                    <div
                                        className="h-full bg-red-500"
                                        style={{
                                            width: `${(stats.condition_stats.major_damage / stats.total_assets) * 100}%`,
                                        }}
                                    />
                                </div>
                                <div className="flex justify-between text-xs text-muted-foreground">
                                    <span>
                                        Baik: {stats.condition_stats.good}
                                    </span>
                                    <span>
                                        Rusak:{' '}
                                        {stats.condition_stats.minor_damage +
